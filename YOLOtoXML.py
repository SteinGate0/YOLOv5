...
def txtLabel_to_xmlLabel(source_txt_path,source_img_path,save_xml_path):
    ...
    classes = ['chefcap','nochefcap','chefuniform','nochefuniform','person']
    print(classes)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_txt_path', type=str, default="D:\PyCharm\MyProjcet\Mask_test\yolov5_61\data\Cooker\ori_data/14_output//txt")
    parser.add_argument('--source_img_path', type=str, default="D:\PyCharm\MyProjcet\Mask_test\yolov5_61\data\Cooker\ori_data//14")
    parser.add_argument('--save_xml_path', type=str, default="D:\PyCharm\MyProjcet\Mask_test\yolov5_61\data\Cooker\ori_data//14_output//xml")
